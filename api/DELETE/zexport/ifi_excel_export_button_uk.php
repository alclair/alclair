...
$url=$rootScope["RootUrl"]."/api/ifi_uk/ifi_excel_export_uk.php?movement=$movement&StartDate=$startdate&EndDate=$enddate&category_id=$category_id&company_id=$company_id&UserId=$UserId&IsAdmin=$IsAdmin&IsManager=$IsManager&token=".$rootScope["SWDApiToken"];
