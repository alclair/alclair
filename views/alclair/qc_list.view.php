...
-->
					...
					<!--<td  ng-if="qc_form.build_type=='New Build - First Pass'"  style="text-align:center;" data-title="Build Type">First Pass</td>
					<td  ng-if="qc_form.build_type=='Repair'"  style="text-align:center;" data-title="Build Type">Repair</td>
					<td  ng-if="qc_form.build_type=='New Build - Originally failed QC'"  style="text-align:center;" data-title="Build Type">Not First Pass</td>-->
					...
					<!-- DISABLED CODE BELOW BECAUSE IT TOOK TOO LONG TO LOAD
						    IT SHOWS WHICH ATTACHMENTS WERE AVAILABLE FOR EACH QC FORM -->
					<!--
					<td data-title="Attachments	">
						<div style="text-align:center;" ng-repeat='file in fileList' ng-if="file.qc_form_id==qc_form.id"> 
							<span ng-hide="file.filepath.indexOf('.pdf')!=-1">
								<a href="<?=$rootScope["RootUrl"]?>/data/{{file.filepath}}" data-lightbox="<?=$rootScope["RootUrl"]?>/data/{{file.filepath}}" data-title="{{QC_Form}}">
									{{file.filepath}}
								</a>
							</span>
                    ...
                    <td data-title="Options">
	                    <div style="text-align:center;" >  
                        	<a class="glyphicon glyphicon-check" style="cursor: pointer;" title="View Form" href="<?=$rootScope['RootUrl']?>/alclair/edit_qc_form/{{qc_form.id}}"></a>
