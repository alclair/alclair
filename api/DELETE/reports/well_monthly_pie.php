...
{	  
    ...
    $cal_type = "sum(t1.barrels_delivered)";
    if(empty($_REQUEST['cal_type']) == false && $_REQUEST['cal_type'] == 'avg')
        $cal_type = "round(avg(t1.barrels_delivered),2)";
    ...
    $query = "select t3.type as water_type,  $cal_type as total_barrels_delivered
