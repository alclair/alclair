...
$url=$rootScope["RootUrl"]."/api/ifi/ifi_excel_export_serial_numbers.php?category_id=$category_id&product_id=$product_id&status=$status&UserId=$UserId&IsAdmin=$IsAdmin&IsManager=$IsManager&token=".$rootScope["SWDApiToken"];
