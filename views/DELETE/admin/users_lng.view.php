                    ...
                    <div class="modal-body">
                        <div class="row">
							...
							<div class="form-group col-md-4">
                                ...
                                <label ng-if="recordAdd.is_customer!=1"><input ng-if="recordAdd.is_customer!=1" type="checkbox" ng-model="recordAdd.is_superuser" ng-true-value="1" ng-false-value="0"> Admin</label>
								<label ng-if="recordAdd.is_customer!=1"><input ng-if="recordAdd.is_customer!=1" type="checkbox" ng-model="recordAdd.is_staff" ng-true-value="1" ng-false-value="0"> Manager</label>
								<label><input type="checkbox" ng-model="recordAdd.is_customer" ng-true-value="1" ng-false-value="0"> Customer</label>
                            </div>
                            <div class="form-group col-md-4">
                                <label   ng-if="recordAdd.is_customer==1" class="control-label">Customer:</label><br />
								<select ng-if="recordAdd.is_customer==1" class='form-control' ng-model='recordAdd.customer_id' ng-options="customer.id as customer.customer_name for customer in customerList">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
							...
							<div class="form-group col-md-4">
                                <label class="control-label">User Role:</label><br />
                                <label ng-if="recordEdit.is_customer!=1"><input ng-if="recordEdit.is_customer!=1" type="checkbox" ng-model="recordEdit.is_superuser" ng-true-value="1" ng-false-value="0"> Admin</label>
								<label ng-if="recordEdit.is_customer!=1"><input ng-if="recordEdit.is_customer!=1" type="checkbox" ng-model="recordEdot.is_staff" ng-true-value="1" ng-false-value="0"> Manager</label>
								<label><input type="checkbox" ng-model="recordEdit.is_customer" ng-true-value="1" ng-false-value="0"> Customer</label>
                            </div>
                            <div class="form-group col-md-4">
                                <label   ng-if="recordEdit.is_customer==1" class="control-label">Customer:</label><br />
								<select ng-if="recordEdit.is_customer==1" class='form-control' ng-model='recordEdit.customer_id' ng-options="customer.id as customer.customer_name for customer in customerList">
									<option value="">Select a customer</option>
								</select>
	                        </div>
                        </div>
...
<script src="<?=$rootScope["RootUrl"]?>/includes/app/adminUserCtrl_LNG.js"></script>
<?php
