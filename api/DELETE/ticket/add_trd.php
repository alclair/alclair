...
*/
	...
	// IF FLUID DOES NOT EXIST, ADD THE FLUID INTO THE TANK
   	$params[":tank_id"] = $ticket["tank_id"];
   	$params[":fluid_id"] = $ticket["fluidtypeid"];
    $get_tank_info = pdo_query($pdo, 'SELECT * FROM tank_tracker WHERE tank_id = :tank_id AND fluid_id = :fluid_id', $params);
    ...
    if( empty($tank_info) )     
    {
	    ...
	    $query = "INSERT INTO tank_tracker (tank_id,  fluid_id, fluid_amount)
	    				VALUES(:tank_id, :fluid_type_id, :fluid_amount)";
