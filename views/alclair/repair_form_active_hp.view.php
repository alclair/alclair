        	...
        	<div class="row">
            	<div class="col-md-12">
                	<div style="border-bottom: 1px solid rgba(144, 128, 144, 0.4); padding-bottom: 15px; margin-bottom: 25px;">
                    	<b style="font-size: 20px;"><a href="<?=$rootScope['RootUrl']?>/alclair/repair_list_active_hp">RMA Form</a> - New Form</b>
                	</div>
            	</div>
        	</div>
	    </div>
				...
				<div ng-repeat="fault in faults">
					<div class="row">
						...
						<div class="form-group col-md-3">
							 ...
							 <select ng-if="fault.classification == 'Ownership Transfer'" class='form-control' ng-model='fault.description_id' ng-options="fault.id as fault.ownership_transfer_fault for fault in ownershipTransferFaultsList" ></select>
