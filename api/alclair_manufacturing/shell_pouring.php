...
$query = pdo_query($pdo, "SELECT * FROM repair_status_table WHERE status_of_repair = 'Shell Pouring'", null);
...
$query = pdo_query($pdo, "SELECT * FROM order_status_table WHERE status_of_order = 'Shell Pouring'", null);
$result = pdo_fetch_array($query);
