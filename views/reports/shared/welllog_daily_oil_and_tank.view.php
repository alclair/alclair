<div ng-controller="reportWellLogDailyOilAndTank">
    <div style="width: 100%; margin-left: auto; margin-right: auto;">
        <div style="text-align: center;">
            <h1 style="font-weight: bold;">Daily Oil Sales and Tankage</h1>         
             Disposal Well:
        ...
        <div id="div_welllog_daily_oil_and_tank"></div>
    </div>
</div>

<script src="<?=$rootScope["RootUrl"]?>/includes/app/reportWellLogDailyOilAndTank.js"></script>
