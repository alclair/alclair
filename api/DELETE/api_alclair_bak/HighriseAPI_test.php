...
include_once("../../lib/HighriseAPI.class.php");
//echo getcwd() . "\n";
//$dir    = "../../lib";
//$files1 = scandir($dir);
...
$argv = array();
$argv[0] = 'php HighriseAPI.test.php';
$argv[1] = "https://matrics.highrisehq.com/";
//$argv[1] = "matrics";
$argv[1] = 'matrics.highrisehq.com/';
$argv[2] = "55e162ff41565e6d97257cfce5421b7c";


if (count($argv) != 3)
		die("Usage: php HighriseAPI.test.php [https://matrics.highrisehq.com/] [a9b558d2e598ecaa3539410cd4e5ca38]\n");
$hr = new HighriseAPI();
$hr->debug = false;
...
//echo $hr;
$people = $hr->findPeopleBySearchTerm("Alters");
foreach($people as $p)
