...
$stmt = pdo_query( $pdo,  "SELECT products.*, t2.name AS category,
(SELECT COUNT(*) FROM serial_numbers_uk WHERE serial_numbers.product_id = products.id AND serial_numbers.active = TRUE) AS total_quantity,
(SELECT COUNT(*) FROM serial_numbers_uk WHERE serial_numbers.product_id = products.id AND serial_numbers.status='SEALED' AND serial_numbers.active = TRUE) AS sealed_quantity,
(SELECT COUNT(*) FROM serial_numbers_uk WHERE serial_numbers.product_id = products.id AND serial_numbers.status='AMAZON' AND serial_numbers.active = TRUE) AS amazon_quantity,
(SELECT COUNT(*) FROM serial_numbers_uk WHERE serial_numbers.product_id = products.id AND serial_numbers.status='DEMO' AND serial_numbers.active = TRUE) AS demo_quantity,
(SELECT COUNT(*) FROM serial_numbers_uk WHERE serial_numbers.product_id = products.id AND serial_numbers.status='FAULTY' AND serial_numbers.active = TRUE) AS faulty_quantity,
(SELECT COUNT(*) FROM serial_numbers_uk WHERE serial_numbers.product_id = products.id AND serial_numbers.status='SHIPPED' AND serial_numbers.active = TRUE) AS shipped_quantity
...
WHERE products.active = TRUE AND products.category_id = :category_id $condition_product ORDER BY products.id", $params_product); 
		...
		foreach ($result_product as $product) {
			...
			$stmt = pdo_query( $pdo, "SELECT * FROM serial_numbers_uk WHERE active = TRUE AND category_id = :category_id AND product_name = :product_name $condition_status
