...
<div ng-controller="ifi_SerialNumber_History">
    <!-- Main Container Starts -->
    <div class="press-enter" style="width:99%;margin-left:10px;">
        <div class="row">
            <div class="col-md-3">
                <a href="<?=$rootScope['RootURL']?>/ifi_uk/orders_uk"><b style="font-size:20px"></a> (Total: {{TotalRecords}})</b>&nbsp;&nbsp;<b style="display:inline; font-size:20px; color: #007FFF"></b>
            </div>
		...
		<table>		
			...
			<tbody>
				<tr ng-repeat='order in OrdersList'>
					<td  style="text-align:center;" data-title="Date">{{order.date}}</td>
					<td  style="text-align:center;" data-title="Movement">{{order.status}}</td>
					<td  style="text-align:center;" data-title="Type">{{order.notes}}</td>
					<td  style="text-align:center;" data-title="Log ID">{{order.log_id}}</td>					
