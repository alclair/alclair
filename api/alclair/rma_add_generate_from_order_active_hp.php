...
try
{
	...
	$repair_form = array();
	$repair_form['customer_name'] = $_POST['designed_for'];
	...
	$repair_form['shell_left_color'] = $_POST['left_shell'];
	$repair_form['shell_right_color'] = $_POST['right_shell'];
	$repair_form['shell_left_face'] = $_POST['left_faceplate'];
	$repair_form['shell_right_face'] = $_POST['right_faceplate'];
	$repair_form['shell_left_tip'] = $_POST['left_tip'];
	$repair_form['shell_right_tip'] = $_POST['right_tip'];
