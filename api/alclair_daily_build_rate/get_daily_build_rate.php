...
{     
	...
	$query4 = "SELECT DISTINCT fake_imp_date FROM import_orders WHERE order_status_id = 1 and active = TRUE ORDER BY fake_imp_date LIMIT 5";
    $stmt4 = pdo_query( $pdo, $query4, null); 
