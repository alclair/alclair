...
$url=$rootScope["RootUrl"]."/api/ifi/ifi_excel_export.php?movement=$movement&StartDate=$startdate&EndDate=$enddate&category_id=$category_id&company_id=$company_id&UserId=$UserId&IsAdmin=$IsAdmin&IsManager=$IsManager&token=".$rootScope["SWDApiToken"];
