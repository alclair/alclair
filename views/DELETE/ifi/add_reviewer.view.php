...
?>
<br />
<div id="main-container" class="container" ng-controller="enter_Person">
    ...
    <form role="form">
	    <div class="container">
			...
			<div class="row">
	        	<div class="form-group col-md-3">
		        	<div class="text-left">
						<button  style="font-weight: 600; border-radius: 4px;" type="button" class="btn btn-primary" ng-click="Submit($event)">
