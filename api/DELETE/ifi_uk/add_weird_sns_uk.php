...
// WE DO NOT WANT A NEW LINE INSERTED 	INTO THE LOG MOVEMENT TABLE
    $stmt = pdo_query( $pdo, 
					   "INSERT INTO log_movement_uk (movement, movement_type, date)
...
//////////////////////////////////////////////////////////////////// 		SEALED 		////////////////////////////////////////////////////////////////////////////////////////
	for ($i = 0; $i < $num_new; $i++) {
		$stmt = pdo_query( $pdo, 'SELECT * FROM serial_numbers_uk WHERE serial_number = :sn_new', array(":sn_new"=>$new[$i]) );	
		$result = pdo_fetch_all($stmt);
		if ( count($result) > 0) {
...
//////////////////////////////////////////////////////////////////////                AMAZON           ////////////////////////////////////////////////////////////////////////
	...
	for ($i = 0; $i < $num_amazon; $i++) {
		$stmt = pdo_query( $pdo, 'SELECT * FROM serial_numbers_uk WHERE serial_number = :sn_amazon', 	array(":sn_amazon"=>$amazon[$i]) );	
		$result = pdo_fetch_all($stmt);
		if ( count($result) > 0) {
...
//////////////////////////////////////////////////////////////////////               DEMO           ///////////////////////////////////////////////////////////////////////////////
	...
	for ($i = 0; $i < $num_demo; $i++) {
		$stmt = pdo_query( $pdo, 'SELECT * FROM serial_numbers_uk WHERE serial_number = :sn_demo', array(":sn_demo"=>$demo[$i]) );	
		$result = pdo_fetch_all($stmt);
		if ( count($result) > 0) {
...
//////////////////////////////////////////////////////////////////////               FAULTY           ///////////////////////////////////////////////////////////////////////////////
	...
	for ($i = 0; $i < $num_faulty; $i++) {
		$stmt = pdo_query( $pdo, 'SELECT * FROM serial_numbers_uk WHERE serial_number = :sn_faulty', array(":sn_faulty"=>$faulty[$i]) );	
		$result = pdo_fetch_all($stmt);
		if ( count($result) > 0) {
