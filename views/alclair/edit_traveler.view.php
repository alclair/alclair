        ...
        <div class="row">
            <div class="col-md-12"  style="border-bottom: 1px solid rgba(144, 128, 144, 0.4); padding-bottom: 15px; margin-bottom: 25px;">
                ...
                <div class="col-md-3" style="margin-left:-120px;margin-top:-5px">  
					...
					<div class="col-md-2">  
						<button ng-if="(manufacturing_screen==0) && (the_user_is == 'Amanda' || the_user_is == 'Marc' || the_user_is == 'admin')" style="font-weight: 600;border-radius: 4px" type="button" class="btn btn-warning" ng-click="showOnManufacturingScreen()">
                        	<i ></i> &nbsp; URGENT                         
						</button>
						<button ng-if="(manufacturing_screen==1) && (the_user_is == 'Amanda' || the_user_is == 'Marc' || the_user_is == 'admin')" style="font-weight: 600;border-radius: 4px" type="button" class="btn btn-danger" ng-click="removeFromManufacturingScreen()">
                       		<i ></i> &nbsp; NOT URGENT                         
					   	</button>
					</div>
			</div>
