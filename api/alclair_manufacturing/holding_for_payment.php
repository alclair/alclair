...
$query = pdo_query($pdo, "SELECT * FROM repair_status_table WHERE status_of_repair = 'Holding For Payment'", null);
...
$query = pdo_query($pdo, "SELECT * FROM order_status_table WHERE status_of_order = 'Holding For Payment'", null);
$result = pdo_fetch_array($query);
