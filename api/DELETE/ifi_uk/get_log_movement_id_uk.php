...
$stmt = pdo_query( $pdo, 
					   "INSERT INTO log_movement_uk (movement, movement_type, company, name, address_1, address_2, city, state, zip_code, country, date, notes, carrier_id, warehouse_id, ordertype_id, po_number, shipping_cost, tracking, title)
