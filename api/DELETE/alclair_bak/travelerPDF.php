...
//$bc->barcode_bar_thick = 1.8; 
// set barcode bar thickness (thin bars) 
//$bc->barcode_bar_thin = .5; 
...
"	<tr  style=\"color:blue;\">
    		<td style=\"text-align:left;font-size:30px;\"><b>" . $result[0]["left_alclair_logo"] . "</b></td>
    		<td style=\"text-align:left;font-size:30px;\"><b>" . $result[0]["right_alclair_logo"] . "</b></td>
	</tr>
";
...
";
	...
	if (strlen($result[0]["clear_canal"]) == 2 ) { // 2 MEANS THAT CLEAR CANAL IS "NO" - 2 CHARACTERS LONG
		$right_column_tips = 
"	<tr>
