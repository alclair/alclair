...
{	  
    ...
    $query = "select to_char(t1.date_delivered,'yyyy-MM-dd') as created,t3.name as name,twater.type as water_type,
              sum(t1.barrels_delivered) as total_barrels_delivered              
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setTitle("Trucking Company");
    $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue("A$StartRowIndex","Trucking Company")
    ...
    //Set Header
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue("A1","Export-TruckingCompany-From(".str_replace("/","-",$startdate).")-To(".str_replace("/","-",$enddate).")");
    ...
    $filename = "Export-TruckingCompany-From(".str_replace("/","-",$startdate).")-To(".str_replace("/","-",$enddate).")-".time().".xlsx";
    //$filename = "hello.xlsx";
