...
$query = pdo_query($pdo, "SELECT * FROM repair_status_table WHERE status_of_repair = 'Exp Assembly'", null);
...
$query = pdo_query($pdo, "SELECT * FROM order_status_table WHERE status_of_order = 'Exp Assembly'", null);
$result = pdo_fetch_array($query);
