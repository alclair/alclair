...
{     
	...
	*/
    //Get Total Records
    $query = "select count(t1.id) from ticket_tracker_oil as t1
    ...
    else
    {
        ...
        twell.file_number as source_well_file_number,twell.current_well_name as source_well_name, toperator.name as source_well_operator_name,
			t3.common_name as disposal_well_name,toperator.id as operator_id, t5.name as tank_name, t6.type as fluid_type
