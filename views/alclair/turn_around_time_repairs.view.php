...
<div ng-controller="TAT_Repair">
    ...
    <div class="press-enter" style="width:99%;margin-left:10px;">
        <div class="row">
            <div class="col-md-4">
                <a href="<?=$rootScope['RootURL']?>/alclair/repairs_list"><b style="font-size:20px">Repairs Over The Average</a> (Total: {{TotalRecords}})</b>&nbsp;&nbsp;<b style="display:inline; font-size:20px; color: #007FFF"></b><span style="color: #FF0000"> </span></a>
            </div>
        </div>
