...
// ORDER STATUS LOG
// IMPORT ORDERS			
$stmt = pdo_query( $pdo, "INSERT INTO repair_status_log (date, repair_form_id, repair_status_id, notes,  user_id) VALUES (:date, :repair_form_id, :status_id, :notes, :user_id) RETURNING id",
