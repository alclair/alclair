...
{		
    ...
    {			       
		$query = "Update auth_user set 
                 ...
                 password = :password,is_superuser=:is_superuser,is_staff=:is_staff where id = :id";
	...
	{	
	    $query = "Update auth_user set 
                  username = :username, first_name = :first_name,
                  last_name = :last_name, email = :email,is_superuser=:is_superuser,is_staff=:is_staff where id = :id";
	    $params = array(
                        ":username" => $_REQUEST["username"],
		                ":first_name" => $_REQUEST["first_name"],
		                ":last_name" => $_REQUEST["last_name"],
