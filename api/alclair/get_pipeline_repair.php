...
*/
	...
	//if( strlen($_REQUEST['TODAY_OR_NEXT_WEEK']) == 17) {   // , 'Today and Tomorrow') ) {
		if( $_REQUEST['TODAY_OR_NEXT_WEEK'] == '1') {   // MEANS TODAY
			...
			$conditionSql.=" and (t1.estimated_ship_date = :Date) AND (t1.repair_status_id != 14 AND t1.repair_status_id != 12 AND t1.repair_status_id != 13 AND t1.repair_status_id != 15 AND t1.repair_status_id != 16)";
			$params[":Date"]=  $today_4_sql;
		} elseif ($_REQUEST['TODAY_OR_NEXT_WEEK'] == '0') { // MEANS PAST DUE
			//$conditionSql.=" and (t1.estimated_ship_date < :Date) AND t1.repair_status_id != 14";
			$conditionSql.=" and (t1.estimated_ship_date < :Date) AND (t1.repair_status_id != 14 AND t1.repair_status_id != 12 AND t1.repair_status_id != 13 AND t1.repair_status_id != 15 AND t1.repair_status_id != 16)";
			...
			$conditionSql.=" and (t1.estimated_ship_date > :Today) AND (t1.estimated_ship_date <= :Date) AND (t1.repair_status_id != 14 AND t1.repair_status_id != 12 AND t1.repair_status_id != 13 AND t1.repair_status_id != 15 AND t1.repair_status_id != 16)";
			$params[":Today"] = $today_4_sql;	
