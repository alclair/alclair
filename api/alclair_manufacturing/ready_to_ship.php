...
$query = pdo_query($pdo, "SELECT * FROM repair_status_table WHERE status_of_repair = 'Ready To Ship'", null);
...
$query = pdo_query($pdo, "SELECT * FROM order_status_table WHERE status_of_order = 'Ready To Ship'", null);
$result = pdo_fetch_array($query);
