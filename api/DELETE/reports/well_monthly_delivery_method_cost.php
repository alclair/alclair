...
{	      
    ...
    $query = "select to_char(t1.date_delivered,'dd') as created, t1.delivery_method as delivery_method,
              ...
              order by created asc, delivery_method asc";  
    ...
    foreach($result as $ticket)
    {
        if($ticket["created"] == $last_created && $ticket["delivery_method"] == $last_delivery_method)
        {
        ...
        else
        {
            ...
            $last_delivery_method = $ticket["delivery_method"]; 
        }
    }
