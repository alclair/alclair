...
try
{
    ...
    {   
        ...
        $stmt = pdo_query(
                            $pdo,
                            "INSERT INTO materials_indexupload
                            ( filepath, date_uploaded,  uploaded_by_id, material_id)
                            VALUES
                            ( :filepath, now(), ".$_SESSION["UserId"].", :material_id);", 
                            array( ":filepath" => $file_name, ":material_id" => $_REQUEST['id'] )
                         );
