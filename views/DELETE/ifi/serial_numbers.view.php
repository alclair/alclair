		...
		<table>		
			...
			<tbody>
				<tr ng-repeat='order in OrdersList'>
					...
					<td  style="text-align:center;" data-title="Serial Number"><a href="<?=$rootScope['RootUrl']?>/ifi/serial_number_history/{{order.serial_number}}">{{order.serial_number}}</a></td>
					<td  style="text-align:center;" data-title="Status">{{order.status}}</td>					
                    <td data-title="Options">
	                    <div style="text-align:center;" >  
							<a class="glyphicon glyphicon-check" style="cursor: pointer;" title="View History" href="<?=$rootScope['RootUrl']?>/ifi/serial_number_history/{{order.serial_number}}"></a>
