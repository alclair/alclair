swdApp.controller('Glowforge', ['$http', '$scope', 'AppDataService', '$upload',  function ($http, $scope, AppDataService, $upload) {
    $scope.input = {};
	$scope.Calculate = function () {	
		$scope.output = Math.round((Number($scope.input.IEM_Height) + Number($scope.input.Base_Height) - 1.30 ) * 1000) / 1000;
		console.log("YO " +$scope.input.IEM_Height)	
	}
