swdApp.controller('Manufacturing_Screen_For_Marc', ['$http', '$scope', 'AppDataService', '$upload',  '$cookies', function ($http, $scope, AppDataService, $upload, $cookies) {
	$scope.OrdersList = {};
	$scope.labels5 = [];
	$scope.labelRange5 = [];    		
    ...
    $scope.RefreshPage = function () {
	    ...
	    var store_the_plot = $scope.the_plot;
		localStorage.setItem("store_the_month", store_the_month);
		localStorage.setItem("store_the_plot", store_the_plot);
    ...
    $scope.CustomBarChart2 = function () {
       myblockui();
	...
	$scope.reloadPage = function() {
		 //$cookies.put("the_plot", $scope.the_plot);
		 var store_the_plot = $scope.the_plot;
		 localStorage.setItem("store_the_plot", $scope.the_plot);
		 location.reload();
	}
    ...
    $scope.init = function () {
	    ...
	    if(store_the_plot == 'day') {
		    ...
		    $scope.the_plot = 'month';
			//$scope.LoadData2();
			$scope.CustomBarChart2(store_the_month); 
		}
    }
