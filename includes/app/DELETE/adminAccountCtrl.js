swdApp.controller('adminAccountCtrl', ['$http', '$scope', 'AppDataService', function ($http, $scope, AppDataService) {
    $scope.recordList = {};   //List of Record
    $scope.recordAdd = {};    //Add of Record
    $scope.recordEdit = {};   //Edit of Record
    $scope.apifolder = "accounting";
    $scope.entityName = "Accounting";
    $scope.entityName2 = "Customer";
    $scope.parent_accounting_list = window.cfg.parent_accounting_list;
    ...
    $scope.LoadData = function () {
        myblockui();
        var api_url = window.cfg.apiUrl + "accounting/get.php?PageIndex=" + $scope.PageIndex + "&PageSize=" + $scope.PageSize + "&SearchText=" + $scope.SearchText;
    ...
    $scope.loadRecordEdit = function (id) {
        ...
        AppDataService.loadAccountCodes(null, null, function (result) {
            $scope.accountCodes = result.data;
        }, function (result) { });
