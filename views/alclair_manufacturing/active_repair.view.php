					...
					<br/><br/>
					 <div class = "form-group col-md-9 text-center">
					 	<span class="input-group-btn">
							<button class="btn btn-success js-new pull-right btn-lg" style="font-weight: 600; border-radius: 4px;"  ng-click="Accept('active_repair');">
		...
		<table>		
			...
			<tbody>
				<tr ng-repeat='repair_form_active_hp in RepairsList_Active_HP'>
					...
					<td  style="text-align:center;" data-title="Last Scanned">{{repair_form_active_hp.date_of_last_scan}}</td>
