	                    ...
	                    <div class="row">
							<div class="form-group col-md-6">
								...
								<div class="text-left">
									...
									<label><input type="checkbox" ng-model="repair_form.repaired_shell" ng-true-value="1" ng-false-value="0"> REPAIRED SHELL</label><br />
									<label><input type="checkbox" ng-model="repair_form.repaired_faceplate" ng-true-value="1" ng-false-value="0"> REPAIRED FACEPLATE</label><br />
									<label><input type="checkbox" ng-model="repair_form.repaired_jacks" ng-true-value="1" ng-false-value="0"> REPAIRED JACKS</label><br />
									<label><input type="checkbox" ng-model="repair_form.replaced_drivers" ng-true-value="1" ng-false-value="0"> REPLACED DRIVER(S)</label><br />
							</div>
							<div class="form-group col-md-6" style="margin-top: 10px;">
								...
								<div class="text-left">
									...
									<label><input type="checkbox" ng-model="repair_form.new_shells" ng-true-value="1" ng-false-value="0"> NEW SHELLS</label><br />
									<label><input type="checkbox" ng-model="repair_form.replaced_tubes" ng-true-value="1" ng-false-value="0"> REPLACED TUBES</label><br />
									<label><input type="checkbox" ng-model="repair_form.cleaned" ng-true-value="1" ng-false-value="0"> CLEANED</label><br />
									<label><input type="checkbox" ng-model="repair_form.adjusted_fit" ng-true-value="1" ng-false-value="0"> ADJUSTED FIT</label><br />								
	   						</div>
            			</div> <!-- END ROW -->
            			 <div class="row">
    ...
    <form role="form">
        ...
        <br />
        	...
        	<div class="row">
				...
				<div class="form-group col-md-6">
					<label class="control-label" style="color:blue">IGNORE THESE CHECKBOXES FOR NOW</label><br />
						<label><input type="checkbox" ng-model="repair_form.repaired_shell" ng-true-value="1" ng-false-value="0"> REPAIRED SHELL</label>
						<label style="margin-left:12px;"><input type="checkbox" ng-model="repair_form.repaired_faceplate" ng-true-value="1" ng-false-value="0"> REPAIRED FACEPLATE</label>
						<label style="margin-left:12px;"><input type="checkbox" ng-model="repair_form.repaired_faceplate" ng-true-value="1" ng-false-value="0"> REPAIRED FACEPLATE</label>
						<br/>
						
						<label><input type="checkbox" ng-model="repair_form.repaired_jacks" ng-true-value="1" ng-false-value="0"> REPAIRED JACKS</label>
						<label style="margin-left:12px;"><input type="checkbox" ng-model="repair_form.replaced_drivers" ng-true-value="1" ng-false-value="0"> REPLACED DRIVER(S)</label><br />
