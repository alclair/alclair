...
$query = pdo_query($pdo, "SELECT * FROM repair_status_table WHERE status_of_repair = 'Repair on Hold'", null);
...
$query = pdo_query($pdo, "SELECT * FROM order_status_table WHERE status_of_order = 'Repair on Hold'", null);
$result = pdo_fetch_array($query);
