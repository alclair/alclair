	...
	if ($_REQUEST['order_status_id'] > 0 ) {
		...
		*/
		...
		if( $_REQUEST['TODAY_OR_NEXT_WEEK'] == '1') {   // MEANS TODAY
			$conditionSql.=" and ( (t1.received_date + INTERVAL '14 days') = :Date) AND (t1.order_status_id != 12 AND  t1.order_status_id != 11 AND t1.order_status_id != 13 AND t1.order_status_id != 14 AND t1.order_status_id != 16)";
			...
			$conditionSql.=" and ((t1.received_date + INTERVAL '14 days') > :Today) AND ((t1.received_date + INTERVAL '14 days') <= :Date) AND (t1.order_status_id != 12 AND  t1.order_status_id != 11 AND t1.order_status_id != 13 AND t1.order_status_id != 14 AND t1.order_status_id != 16)";
