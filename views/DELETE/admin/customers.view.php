...
<div ng-controller="adminCustomerCtrl">
            ...
            <div class="col-md-6">
				<div class="input-group">
					<div style="float:right;">
						<input type="text" placeholder="search by customer name" style="min-width:400px;" class="form-control" ng-enter="Search()" ng-model="SearchText"/><br />                    
					</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="control-label">Customer:</label><br />
                                <input type="text" value="" ng-model="recordEdit.customer_name" class='form-control' required>
                            </div>
                            <!--<div class="form-group col-md-12">
                                <label class="control-label">Login:</label><br />
...
<script src="<?=$rootScope["RootUrl"]?>/includes/app/adminCustomerCtrl_LNG.js"></script>
<?php
