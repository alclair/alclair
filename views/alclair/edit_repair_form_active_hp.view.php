	                    ...
	                    <div class="row">
							<div class="form-group col-md-6">
								...
								<div class="text-left">
									...
									<label><input type="checkbox" ng-model="repair_form.repaired_shell_right" ng-true-value="1" ng-false-value="0">&emsp; REPAIRED SHELL</label><br/>&nbsp;
									
									<label><input type="checkbox" ng-model="repair_form.repaired_faceplate_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.repaired_faceplate_right" ng-true-value="1" ng-false-value="0">&emsp; REPAIRED FACEPLATE</label><br/>&nbsp;
									
									<label><input type="checkbox" ng-model="repair_form.replaced_faceplate_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.replaced_faceplate_right" ng-true-value="1" ng-false-value="0"> &emsp;REPLACED FACEPLATE</label><br/>&nbsp;
									
									<label><input type="checkbox" ng-model="repair_form.replaced_mic_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.replaced_mic_right" ng-true-value="1" ng-false-value="0"> &emsp;REPLACED MIC</label><br/>&nbsp;
									
									<label><input type="checkbox" ng-model="repair_form.repaired_jacks_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.repaired_jacks_right" ng-true-value="1" ng-false-value="0"> &emsp;REPAIRED JACKS</label><br/>&nbsp;
									<label><input type="checkbox" ng-model="repair_form.touched_up_wires_chip_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.touched_up_wires_chip_right" ng-true-value="1" ng-false-value="0"> &emsp;TOUCHED UP WIRES/CHIP</label><br/>&nbsp;
									<label><input type="checkbox" ng-model="repair_form.replaced_driver_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.replaced_driver_right" ng-true-value="1" ng-false-value="0"> &emsp;REPLACED DRIVER(S)</label><br/>
							</div>
							...
							<div class="form-group col-md-6" style="margin-top: 10px;">
								...
								<div class="text-left">
									...
									<label><input type="checkbox" ng-model="repair_form.new_shells_right" ng-true-value="1" ng-false-value="0"> &emsp;NEW SHELLS</label><br/>&nbsp;
									<label><input type="checkbox" ng-model="repair_form.new_faceplate_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.new_faceplate_right" ng-true-value="1" ng-false-value="0"> &emsp;NEW FACEPLATE</label><br/>&nbsp;
									
									<label><input type="checkbox" ng-model="repair_form.replaced_tubes_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.replaced_tubes_right" ng-true-value="1" ng-false-value="0"> &emsp;REPLACED TUBES</label><br/>&nbsp;
									
									<label><input type="checkbox" ng-model="repair_form.moved_mic_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.moved_mic_right" ng-true-value="1" ng-false-value="0"> &emsp;MOVED MIC</label><br/>&nbsp;
									
									
									<label><input type="checkbox" ng-model="repair_form.cleaned_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.cleaned_right" ng-true-value="1" ng-false-value="0"> &emsp;CLEANED</label><br/>&nbsp;

									<label><input type="checkbox" ng-model="repair_form.replaced_chip_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.replaced_chip_right" ng-true-value="1" ng-false-value="0"> &emsp;REPLACED CHIP</label><br/>&nbsp;

									
									<label><input type="checkbox" ng-model="repair_form.adjusted_fit_left" ng-true-value="1" ng-false-value="0">&nbsp;&nbsp;&emsp;</label>
									<label><input type="checkbox" ng-model="repair_form.adjusted_fit_right" ng-true-value="1" ng-false-value="0"> &emsp;ADJUSTED FIT</label><br/>&nbsp;							
