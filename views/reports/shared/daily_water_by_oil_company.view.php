<div ng-controller="reportDailyWaterByOilCompany">
    <div style="width: 100%; margin-left: auto; margin-right: auto;">
        <div style="text-align: center;">
            <h1 style="font-weight: bold;">Daily Water Totals by Oil Company</h1>  
            Disposal Well:
        ...
        <div style="float: right;">
            <label>
                <input type="radio" name="daily_water_by_oil_company_mode" value="grouped" id="daily_water_by_oil_copany_grouped">
                Grouped</label>
            <label>
                <input type="radio" name="daily_water_by_oil_company_mode" value="stacked" id="daily_water_by_oil_copany_stacked" checked>
                Stacked</label>
        </div>
        <div class="col-md-12">            
        ...
        <div id="div_daily_water_by_oil_company"></div>
    </div>
</div>

<script src="<?=$rootScope["RootUrl"]?>/includes/app/reportDailyWaterByOilCompany.js"></script>
