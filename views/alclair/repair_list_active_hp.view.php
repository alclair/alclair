...
<div ng-controller="Repair_List">
    ...
    <div class="press-enter" style="width:99%;margin-left:10px;">
        <div class="row">
            <div class="col-md-3">
                <b style="font-size:20px"> <a href="<?=$rootScope['RootURL']?>/alclair/repair_form_active_hp">Repair List</a> (Total: {{TotalRecords}})</b>&nbsp;&nbsp;<b style="display:inline; font-size:20px; color: #007FFF"></b>
            </div>
		...
		<table>		
			...
			<tbody>
				<tr ng-repeat='repair_form in Repair_FormList'>
					<td  style="text-align:center;" data-title="Customer's Name"><a href="<?=$rootScope['RootUrl']?>/alclair/edit_repair_form_active_hp/{{repair_form.id}}">{{repair_form.customer_name}}</a></td>
                    ...
                    <td data-title="Options">
						...
						<?php } ?>
                        	<a class="glyphicon glyphicon-check" style="cursor: pointer;" title="View Form" href="<?=$rootScope['RootUrl']?>/alclair/edit_repair_form_active_hp/{{repair_form.id}}"></a>
