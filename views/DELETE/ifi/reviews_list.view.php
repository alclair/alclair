...
<div ng-controller="reviewsList">
    <!-- Main Container Starts -->
    <div class="press-enter" style="width:99%;margin-left:10px;">
        <div class="row">
            <div class="col-md-3">
                <a href="<?=$rootScope['RootURL']?>/ifi/orders"><b style="font-size:20px">Reviews</a> (Total: {{TotalRecords}})</b>&nbsp;&nbsp;<b style="display:inline; font-size:20px; color: #007FFF"></b>
            </div>
		...
		<table>		
			<thead>
				<tr>
					...
					<th style="text-align:center;">Request Made By</th>
			...
			<tbody>
				<tr ng-repeat='review in ReviewsList'>
					<td  style="text-align:center;" data-title="Name">{{review.title}} {{review.firstname}} {{review.lastname}}</td>
					<td  style="text-align:center;" data-title="Request Made By">{{review.first_name}} {{review.last_name}}</td>
					<td  style="text-align:center;" data-title="Requested">{{review.requested}}</td>
					
					<td  ng-if="review.approved == 'NEEDS_APPROVAL'" style="text-align:center;" data-title="Impressions Received">Needs Approval</td>
					<td  ng-if="review.approved == 'APPROVED'" style="text-align:center;" data-title="Impressions Received">Approved</td>
					<td  ng-if="review.approved == 'UNAPPROVED'" style="text-align:center;" data-title="Impressions Received">Unapproved</td>
					<td  ng-if="!review.approved" style="text-align:center;" data-title="Impressions Received">NULL</td>

					<td  style="text-align:center;" data-title="Date">{{review.date}}</td>
									
                    <td data-title="Options">
	                    <div style="text-align:center;" >  
							<a class="glyphicon glyphicon-check" style="cursor: pointer;" title="Open" href="<?=$rootScope['RootUrl']?>/ifi/open_review/{{review.id}}"></a>
