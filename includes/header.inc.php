				...
				<?php if($_SESSION["IsAdmin"]==1 || ($_SESSION["IsManager"] == 1 && $rootScope["SWDCustomer"] == "lng")) { ?>
					...
					<?php } elseif($rootScope["SWDCustomer"] == "alclair") { ?>
						<li class="dropdown">
                          ...
                          <?php if($_SESSION["UserName"] == 'admin' || $_SESSION["UserName"] == 'Amanda' || $_SESSION["UserName"] == 'Scott' || $_SESSION["UserName"] == 'Phil' ||$_SESSION["UserName"] == 'Marc' || $_SESSION["UserName"] == 'Andy' || $_SESSION["UserName"] == 'Grace' || $_SESSION["UserName"] == 'Zeeshan' ) { ?>      
                                <li class=" ">
                          ...
                          <? } ?>
                                ...
                                <li class=" ">
                                    <a href="<?=$rootScope['RootUrl']?>/admin/manufacturing_screen" class="nav-link "><i class="fa fa-line-chart"></i> &nbsp Manufacturing Screen </a>
                                </li>
							</ul>
						</li> 
