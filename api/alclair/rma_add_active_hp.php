...
try
{
	...
	$repair_form['original_ship_date_of_order'] = $_POST['original_ship_date_of_order'];
	$repair_form['rma_number'] = $_POST['rma_number'];
	$repair_form['active'] = $_POST['active'];
	$repair_form['personal_item_text'] = $_POST['personal_item_text'];
...
$stmt = pdo_query( $pdo, "INSERT INTO qc_form_active_hp (customer_name, order_id, monitor_id, build_type_id, notes, active, qc_date, pass_or_fail, id_of_repair) 
...
$stmt = pdo_query( $pdo, "UPDATE repair_form_active_hp SET id_of_qc_form = :id_of_qc_form WHERE id = :id_of_repair RETURNING id", array(":id_of_qc_form"=>$id_of_qc_form[0]["id"], ":id_of_repair"=>$id_of_repair));
