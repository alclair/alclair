swdApp.controller('adminDisposalWellCtrl', ['$http', '$scope', function ($http, $scope) {
    $scope.recordList = {};   //List of Record
    $scope.recordAdd = {};    //Add of Record
    $scope.recordEdit = {};   //Edit of Record
    $scope.apifolder = "disposalwell";
    $scope.entityName = "Disposal Well";
    $scope.SearchText = "";
        ...
        $http({
         ...
         .success(function (result) {
             if (result.code == "success") {
                 ...
                 var newrecord = {
                     id: result.data.id,
                     common_name: $scope.recordAdd.common_name,
                 };
