...
try
{
	...
	if( stristr($_POST['model'], "Musician") ) {
		$traveler['musicians_plugs'] = TRUE;
	}
...
full_ear_silicone_earplugs_no_filter, full_ear_silicone_earplugs_switched_9db, full_ear_silicone_earplugs_switched_12db, full_ear_silicone_earplugs_9db, full_ear_silicone_earplugs_12db, canal_fit_earplugs_no_filter, canal_fit_earplugs_9db, canal_fit_earplugs_12db,

		pickup, estimated_ship_date, received_date, date, entered_by,  rush_process, active, impression_color_id, order_status_id, link_to_design_image, hearing_protection_color, nashville_order, fit_adjustment, customer_type, use_for_estimated_ship_date)
		VALUES (
		:order_id, :designed_for, :email, :phone, :band_church, :address, :notes, :model, :left_tip, :right_tip, :left_shell, :right_shell, 
		:left_faceplate, :right_faceplate, :cable_color, :artwork, :left_alclair_logo, :right_alclair_logo, :additional_items, :consult_highrise, :international, :universals, :bite_block_not_used, :hearing_protection, :musicians_plugs, 
		:musicians_plugs_9db, :musicians_plugs_15db, :musicians_plugs_25db, 
		
:full_ear_silicone_earplugs_no_filter, :full_ear_silicone_earplugs_switched_9db, :full_ear_silicone_earplugs_switched_12db, :full_ear_silicone_earplugs_9db, :full_ear_silicone_earplugs_12db, :canal_fit_earplugs_no_filter,  :canal_fit_earplugs_9db, :canal_fit_earplugs_12db,
		
:pickup, :estimated_ship_date, :received_date, :date, :entered_by,  :rush_process, :active, :impression_color_id, 99, ' ',
:hearing_protection_color, :nashville_order, :fit_adjustment, :customer_type, :use_for_estimated_ship_date) RETURNING id",

		array(':order_id'=>$traveler['order_id'], ':designed_for'=>$traveler['designed_for'], ':email'=>$traveler['email'], ':phone'=>$traveler['phone'], ':band_church'=>$traveler['band_church'], ':address'=>$traveler['address'], ':notes'=>$traveler['notes'], ':model'=>$traveler['model'], ':left_tip'=>NULL, ':right_tip'=>NULL, ':left_shell'=>NULL, ':right_shell'=>NULL, ':left_faceplate'=>NULL, ':right_faceplate'=>NULL, ':cable_color'=>NULL, ':artwork'=>NULL, ':left_alclair_logo'=>NULL, ':right_alclair_logo'=>NULL,  ':additional_items'=>$traveler['additional_items'], ':consult_highrise'=>$traveler['consult_highrise'], ':international'=>$traveler['international'], ':universals'=>$traveler['universals'], ':bite_block_not_used'=>$traveler['bite_block_not_used'], ':hearing_protection'=>$traveler['hearing_protection'], ':musicians_plugs'=>$traveler['musicians_plugs'], 
':musicians_plugs_9db'=>$traveler['musicians_plugs_9db'] , 
':musicians_plugs_15db'=>$traveler['musicians_plugs_15db'] , 
':musicians_plugs_25db'=>$traveler['musicians_plugs_25db'] , 
...
if($traveler['hearing_protection']) {
	$stmt = pdo_query( $pdo, 
		...
		:left_faceplate, :right_faceplate, :cable_color, :artwork, :left_alclair_logo, :right_alclair_logo, :additional_items, :consult_highrise, :international, :universals, bite_block_not_used, :hearing_protection, :musicians_plugs, 
		:musicians_plugs_9db, :musicians_plugs_15db, :musicians_plugs_25db, :pickup, :estimated_ship_date, :received_date, :date, :entered_by,  :rush_process, :active, :impression_color_id, 99, ' ', :hearing_protection_color, :nashville_order, :fit_adjustment, :customer_type, :use_for_estimated_ship_date) RETURNING id",
		array(':order_id'=>$traveler['order_id'], ':designed_for'=>$traveler['designed_for'], ':email'=>$traveler['email'], ':phone'=>$traveler['phone'], ':band_church'=>$traveler['band_church'], ':address'=>$traveler['address'], ':notes'=>$traveler['notes'], ':model'=>'SHP', ':left_tip'=>NULL, ':right_tip'=>NULL, ':left_shell'=>NULL, ':right_shell'=>NULL, ':left_faceplate'=>NULL, ':right_faceplate'=>NULL, ':cable_color'=>NULL, ':artwork'=>NULL, ':left_alclair_logo'=>NULL, ':right_alclair_logo'=>NULL,  ':additional_items'=>$traveler['additional_items'], ':consult_highrise'=>$traveler['consult_highrise'], ':international'=>$traveler['international'], ':universals'=>$traveler['universals'], ':bite_block_not_used'=>$traveler['bite_block_not_used'], ':hearing_protection'=>$traveler['hearing_protection'], ':musicians_plugs'=>NULL, ':musicians_plugs_9db'=>NULL, ':musicians_plugs_15db'=>NULL, ':musicians_plugs_25db'=>NULL, ':pickup'=>$traveler['pickup'],':estimated_ship_date'=>$traveler['estimated_ship_date'], ':received_date'=>$traveler['received_date'], ':date'=>$traveler["date"], ":entered_by"=>$_SESSION['UserId'], ':rush_process'=>$traveler['rush_process'],":active"=>TRUE, ':impression_color_id'=>$traveler['impression_color_id'], ':hearing_protection_color'=>$traveler['hearing_protection_color'], ':nashville_order'=>$traveler['nashville_order'], ':fit_adjustment'=>$traveler['fit_adjustment'], ':customer_type'=>$traveler['customer_type'], 'use_for_estimated_ship_date'=>NULL));		
}
