...
{	  
    ...
    $query = "select to_char(t1.date_delivered,'dd') as created,t1.delivery_method as delivery_method,  sum(t1.barrels_delivered) as total_barrels_delivered
              from ticket_tracker_ticket as t1              
              where to_char(date_delivered,'yyyy') = '$year' and to_char(date_delivered,'MM')='$month'  $condition
              group by created ,delivery_method
