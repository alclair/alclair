...
?>
<br />
<div id="main-container" class="container" ng-controller="importQuickBooks">
        	...
        	<div class="row">
            	<div class="col-md-12">
                	<div style="border-bottom: 1px solid rgba(144, 128, 144, 0.4); padding-bottom: 15px; margin-bottom: 25px;">
                    	<b style="font-size: 20px;color: #007FFF">Import File From QuickBooks</b>
                	</div>
            	</div>
        	</div>
        <br />
...
<!-- -->
	<?php
		if ( $rootScope["SWDCustomer"] == "dev" || $rootScope["SWDCustomer"] == "alclair" ) {
	?>
			<script src="<?=$rootScope["RootUrl"]?>/includes/app/QuickBooksImport.js"></script>
    <?php  } 	?>	
