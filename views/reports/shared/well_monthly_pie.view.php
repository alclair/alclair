<div ng-controller="reportWellMonthlyPieCtrl" ng-init="init('sum');">
    <div style="width: 100%; margin-left: auto; margin-right: auto;">
        <div style="text-align: center;">
            ...
            <input type="button" class="btn btn-success btn-sm" ng-click="selectMonth_Pie('sum');" value="Load Report" />
        </div>
        <div id="well_month_report_pie_sum"></div>
        <div style="text-align:center;">
