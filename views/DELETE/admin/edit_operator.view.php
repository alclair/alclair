...
<div ng-controller="adminOperatorEditCtrl" style="margin-top:20px;margin-bottom:20px;">
    <!-- Main Container Starts -->
    <div id="main-container" class="container">
		<b style="font-size: 20px;"><a href="<?=$rootScope['RootUrl']?>/admin/index">Admin Site</a> >> <a href="<?=$rootScope['RootUrl']?>/admin/operators">Operators</a> >> Edit Operator</b>
