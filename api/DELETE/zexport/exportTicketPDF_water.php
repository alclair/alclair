...
{	             
    ...
    if(count($result) > 0)
    {
        ...
        foreach($result as $ticket)
        {
	        ...
	        $total_dollars = $ticket["barrel_rate"]*$ticket["barrels_delivered"];
            //$pdf->lastPage();
            $pdf->AddPage();
...
<table>
    ...
    <tr><td colspan=\"2\" style='height:$td_height;'></td></tr>
    <tr style=\"font-weight:bold;\">
        <td>Disposal Well Name:</td>
        <td>Disposal Well Operator:</td>
    </tr>
    <tr>
    ...
    <tr><td colspan=\"2\" style='height:$td_height;'></td></tr>
    <tr style=\"font-weight:bold;\">
        <td>Disposal Well File Number:</td>
        <td>Trucking Company:</td>
    </tr>
    <tr>
        <td>{$ticket["source_well_file_number"]}</td>
        <td>{$ticket["trucking_company"]}</td>
    </tr>
    <tr><td colspan=\"2\" style='height:$td_height;'></td></tr>
    <tr style=\"font-weight:bold;\">
         <td>Total $:</td>     
