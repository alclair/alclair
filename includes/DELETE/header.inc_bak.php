        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse" ng-controller="HorMenuCtrl">
            <ul class="nav navbar-nav">
				...
				<!-- 	Andy  edited - Was pointing to old database with old Tyler login	-->		
                <?php
					if ( $rootScope["SWDCustomer"] == "dev" ||  $rootScope["SWDCustomer"] == "alclair" ) {
						
						$db_server_alclair="127.0.0.1";
...
-->
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li class=" "><a href="<?=$rootScope['RootUrl']?>/alclair_manufacturing/clark_cart" class="nav-link "> 
									<span style="margin-right:108px;font-weight:bold;">Clark Cart</span>
									<span style="color:#EE7600;font-weight:bold;"> (<? echo $row_alclair_repair["clark_cart"] ?>)</span></a></li> 
								...
								<li class=" "><a href="<?=$rootScope['RootUrl']?>/alclair_manufacturing/repair_on_hold" class="nav-link "> 
									<span style="margin-right:77px;font-weight:bold;">Repair on Hold</span>
									 <span style="color:#EE7600;font-weight:bold;">(<? echo $row_alclair_repair["repair_on_hold"] ?>)</span></a></li> 
